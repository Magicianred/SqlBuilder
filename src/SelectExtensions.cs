...
namespace SqlBuilder
{
  ...
  {
    public static IWhere Where(this Select select, string column, SqlOperator sqlOperator, object value)
    {
      Clause clause = new Clause(select.Parameters, column, sqlOperator, value);
      return select.Where(clause);
    }

    public static IWhere Where(this Select select, string column, object value)
    {
